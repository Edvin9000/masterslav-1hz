...
function render(){const s=signals(state);$('data').setAttribute('aria-pressed',!!s.d);$('data').querySelector('strong').textContent=`D = ${HL(s.d)}`;$('clock').setAttribute('aria-pressed',!!s.clk);$('clock').querySelector('strong').textContent=`CLK = ${HL(s.clk)}`;
